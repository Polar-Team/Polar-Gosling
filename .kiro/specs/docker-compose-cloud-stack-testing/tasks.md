...
- [ ] 5. Implement the seed job (image + orchestrator + fixtures)
  - [ ] 5.1 Create seed fixtures under `compose/seed/fixtures/`
  ...
  - [ ] 5.2 Create `compose/seed/Dockerfile`
  ...
  - [ ] 5.3 Implement `compose/seed/seed.py` — YDB schema creation step
  ...
  - [ ] 5.4 Implement `compose/seed/seed.py` — LocalStack seeding steps
  ...
  - [ ] 5.5 Implement `compose/seed/seed.py` — YDB row seeding and exit contract
  ...
  - [ ] 5.6 Add the `seed` service to `docker-compose.yml`
  ...
  - [ ]* 5.7 Write property test `test_seed_idempotency.py::test_seed_is_idempotent`
  ...
  - [ ]* 5.8 Write property test `test_seed_idempotency.py::test_eventbridge_profile_gated`
  ...
  - [ ]* 5.9 Write unit tests `test_seed_errors.py` for the retry/error paths
...
- [ ] 6. Implement the trigger emulator (script + Dockerfile + Compose wiring)
  - [ ] 6.1 Create `compose/trigger/Dockerfile`
  ...
  - [ ] 6.2 Implement `compose/trigger/trigger.py::parse_interval`
  ...
  - [ ] 6.3 Implement `compose/trigger/trigger.py::main` loop
  ...
  - [ ] 6.4 Add the `trigger-emulator` service to `docker-compose.yml`
  ...
  - [ ]* 6.5 Write property test `test_trigger_emulator.py::test_parse_interval_total_and_bounded`
  ...
  - [ ]* 6.6 Write property test `test_trigger_emulator.py::test_loop_tolerates_all_failure_modes`
  ...
  - [ ]* 6.7 Write property test `test_trigger_emulator.py::test_loop_emits_structured_log_line`
  ...
  - [ ]* 6.8 Write unit tests for the startup `INTERNAL_SYNC_TOKEN` gate
...
- [ ] 7. Wire the MotherGoose and UglyFox services into `docker-compose.yml`
  - [ ] 7.1 Add `mothergoose-api` service
  ...
  - [ ] 7.2 Add `mothergoose-worker` service
  ...
  - [ ] 7.3 Add `uglyfox-worker` service
  ...
  - [ ]* 7.4 Write property test `test_compose_properties.py::test_depends_on_graph`
  ...
  - [ ]* 7.5 Write property test `test_compose_properties.py::test_profile_assignment`
  ...
  - [ ]* 7.6 Write property test `test_compose_properties.py::test_service_env_vars`
  ...
  - [ ]* 7.7 Write property test `test_compose_properties.py::test_uglyfox_env_allowlist`
  ...
  - [ ]* 7.8 Write property test `test_compose_properties.py::test_internal_sync_token_shared`
...
- [ ] 8. Checkpoint — Ensure all compose and seed artifacts pass local validation
...
- [ ] 9. Implement static compose and env validation scripts
  - [ ] 9.1 Create `compose/scripts/check_compose.py`
  ...
  - [ ] 9.2 Create `compose/scripts/check_env.py`
  ...
  - [ ]* 9.3 Write property test `test_env_example_contract.py::test_env_example_shape`
  ...
  - [ ]* 9.4 Write property test `test_env_example_contract.py::test_compose_reference_syntax_matches`
  ...
  - [ ]* 9.5 Write property test `test_env_example_contract.py::test_declared_equals_referenced`
    - **Property 16: Declared and referenced env-var sets are equal**
    - **Validates: Requirement 11.7**
    - `set(declared_vars) == set(referenced_vars)`.

- [ ] 10. Implement the end-to-end smoke test script
  - [ ] 10.1 Create `compose/scripts/smoke_test.py` — driver and step framework
  ...
  - [ ] 10.2 Implement steps (a)–(f) in `smoke_test.py`
  ...
  - [ ]* 10.3 Write unit tests `test_smoke_driver.py` for the driver
  ...
  - [ ]* 10.4 Write property test `test_smoke_driver.py::test_verbose_output_shape`
...
- [ ] 11. Extend `dev-new-features/Makefile` with the `compose-*` targets
  - [ ] 11.1 Add the shared `_preflight` define plus `COMPOSE` and `PROFILES_UP` variables
  ...
  - [ ] 11.2 Add `compose-up`, `compose-down`, `compose-reset`, `compose-logs` targets
  ...
  - [ ] 11.3 Add `compose-smoke`, `compose-clean`, `compose-config`, `compose-check` targets
  ...
  - [ ]* 11.4 Write unit tests `test_makefile_preflight.py`
...
- [ ] 12. Author the CI workflow `dev-new-features/.github/workflows/compose-smoke.yml`
  - [ ] 12.1 Replace the placeholder from task 1.3 with the full workflow
  ...
  - [ ]* 12.2 Write example-based test `test_ci_workflow_shape.py`
...
- [ ] 13. Author `compose/README.md` and run final validation
  - [ ] 13.1 Write `compose/README.md`
  ...
  - [ ]* 13.2 Write example-based test `test_readme_shape.py`
